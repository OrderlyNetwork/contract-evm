...
contract PerpTradeUploadBatchTest is Test {
    ...
    function setUp() public {
        ...
        ledger.setLedgerImplB(address(ledgerImplB));
    ...
    function test_perp_trade_batch_init_holdings_zero() public {
        ...
        trades[0] = PerpTypes.FuturesTradeUpload({
            tradeId: 13,
        ...
        trades[1] = PerpTypes.FuturesTradeUpload({
            tradeId: 14,
            matchId: 1678975214714862536,
            accountId: BOB,
            symbolHash: SYMBOL_HASH_ETH_USDC,
    ...
    function test_perp_trade_batch_increase_positions() public {
    ...
    function test_perp_trade_batch_decrease_positions() public {
