    ...
    function test_adl_V2() public {
        ...
        ledger.cheatSetUserPosition(
            ...
            AccountTypes.PerpPosition({
                ...
                lastSettledPrice: 0,
                averageEntryPrice: 134_040_200, // TODO
                openingCost: 0,
                lastAdlPrice: 0
            })
        );
        ...
        assertEq(ledger.getUserLedgerLastEngineEventId(BOB), 2);
    }
}
