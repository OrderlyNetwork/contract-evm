...
import "./mock/VaultManagerBuggy.sol";
...
contract VaultManagerTest is Test {
    ...
    function setUp() public {
        ...
        IVaultManager vaultManagerImpl = new VaultManagerBuggy();
    ...
    function testFail_sub_add_get() public {
        // should fail due to VaultManagerBuggy
    ...
    function test_sub_add_get() public {
        ...
        admin.upgrade(ITransparentUpgradeableProxy(address(vaultManagerProxy)), address(new VaultManager()));
