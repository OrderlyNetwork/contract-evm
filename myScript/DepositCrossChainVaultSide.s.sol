...
contract DepositCrossChainVaultSide is Script{
    function run() external {
        ...
        bytes memory vaultLzPath = abi.encodePacked(ledgerRelay, vaultRelay);
        ...
        vaultCrossChainManagerInstance.setLedgerCrossChainManager(ledgerSideChainId, ledgerCrossChainManager);
